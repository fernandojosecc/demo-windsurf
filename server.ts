// Importamos los posts del archivo del blog
interface BlogPost {
  id: number;
  title: string;
  summary: string;
...
// Creamos el servidor con Bun
const server = Bun.serve({
  port: 3004, // Usamos un puerto diferente al del frontend (Next.js usa 3000)
  routes: {
    // Endpoint GET para listar todos los posts
    "/posts": {
      GET: () => {
        // Devolvemos los posts como JSON con headers CORS
...
console.log(`🚀 Servidor Bun corriendo en ${server.url}`);
